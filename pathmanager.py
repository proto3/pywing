...
class PathManager(QtCore.QObject):
    ...
    def __init__(self, color):
        ...
        #TODO better used path data directly ?
        self.name = ''
        self.color = color
        self.loaded = False
        self.shift = 0.0
    ...
    def load(self, filename):
        ...
        try:
            ...
            elif extension == '.DAT' or extension == '.COR':
...
class PathManagerWidget(QtGui.QWidget):
    def __init__(self, path_manager):
        ...
        self.widgets = (self.name, self.load_btn, self.scale_spbox, self.kerf_spbox, self.shift_spbox, self.reverse_btn)
